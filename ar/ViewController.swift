...
//  ar
//
//  Created by Tao Tokikwawa on 3/7/24.
//
...
class ViewController: UIViewController, ARSCNViewDelegate, ARSessionDelegate, SCNPhysicsContactDelegate {
    ...
    func renderer(_ renderer: SCNSceneRenderer, updateAtTime time: TimeInterval) {
        ...
        guard let raycastQuery = self.sceneView.raycastQuery(from: screenCenter, allowing: .estimatedPlane, alignment: .horizontal) else { return }
        ...
        if trackerNode == nil { //1
            ...
            trackerNode?.eulerAngles.x = Float(-.pi * 0.5) //3
